...
<head>
    ...
    <title>Đặt lại mật khẩu · EAUT</title>
    ...
    <div class="page-wrap">
        <div class="card">
            ...
            <div class="heading">
                ...
                <p>Nhập mã OTP gửi đến <strong>{{ $email }}</strong> và mật khẩu mới của bạn (Hiệu lực 2 phút)</p>
            </div>
            ...
            <form action="{{ route('password.update') }}" method="POST" id="resetForm">
                ...
                <div class="field">
                    <input type="text" id="otp" name="otp" placeholder="Mã OTP" required autofocus maxlength="6">
