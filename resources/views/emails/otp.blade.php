...
<head>
    ...
    <style>
        ...
        .otp-code { font-size: 42px; font-weight: 800; color: #0062FF; letter-spacing: 8px; margin: 30px 0; padding: 20px; background: #f5f5f7; border-radius: 16px; display: inline-block; width: 80%; }
