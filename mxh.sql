-- ==========================================
-- 🛠️ CÀI ĐẶT BAN ĐẦU (RESET & SETUP DATABASE)
-- ==========================================
-- Xóa database cũ nếu đã tồn tại để làm mới hoàn toàn
DROP DATABASE IF EXISTS threads_clone;

-- Tạo database mới, sử dụng utf8mb4 để hỗ trợ lưu trữ đa ngôn ngữ (Tiếng Việt) và Emoji (rất quan trọng cho MXH)
CREATE DATABASE IF NOT EXISTS threads_clone 
CHARACTER SET utf8mb4 
COLLATE utf8mb4_unicode_ci;

-- Lựa chọn database vừa tạo để thao tác
USE threads_clone;
SET NAMES utf8mb4;
